...
Outputs:
    Raw_data/seoul_ridership/raw/CARD_SUBWAY_MONTH_*.csv  (cached, resume-capable)
    Raw_data/seoul_ridership/file_index.csv               (seqNo ↔ filename map)
"""
...
DEFAULT_OUT_DIR = PROJECT_ROOT / "Raw_data" / "seoul_ridership" / "raw"
DEFAULT_INDEX_PATH = PROJECT_ROOT / "Raw_data" / "seoul_ridership" / "file_index.csv"
