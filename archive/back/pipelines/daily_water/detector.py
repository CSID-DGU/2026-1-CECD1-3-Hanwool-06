...
과거 데이터(data/processed/daily_water_usage.csv) + 수집된 daily CSV를 합쳐
...
HIST_PATH = ROOT / "data" / "processed" / "daily_water_usage.csv"
CAL_PATH  = ROOT / "data" / "processed" / "date_index.csv"
