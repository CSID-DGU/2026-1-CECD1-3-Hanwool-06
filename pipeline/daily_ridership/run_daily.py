...
직접 실행:
  python pipeline/daily_ridership/run_daily.py                        # 어제
  python pipeline/daily_ridership/run_daily.py 2026-05-29             # 특정 날짜
  python pipeline/daily_ridership/run_daily.py 2026-05-24 2026-05-30  # 범위(백필)
